...
import { z } from 'zod'
import { registerMatchLocalSwaggerSchema } from "../../schemaSwagger/registerMatchLocalSchema"

export async function registerMatchLocal(app: FastifyInstance) {
	app.post('/registerMatchLocal', { schema: registerMatchLocalSwaggerSchema }, async(req, res) => {
